...
public class CameraBehavior : MonoBehaviour
{
    ...
    public void MouseInput()
    {
        ...
        if (Input.mouseScrollDelta.y != 0)
        {
            ...
            value = Input.mouseScrollDelta.y * MainCameraControllerVariables.zoomAmount.z;
            //[Range(1.5f, 2.5f)]
            //MainCameraControllerVariables.newZoom.z = value;//= Mathf.Clamp(value, 1.5f, 2.5f);
            if (MainCameraControllerVariables.newZoom.z > 2.5f)
            {
                MainCameraControllerVariables.newZoom.z = 2.5f;
            }
            else if (MainCameraControllerVariables.newZoom.z < 1.5f)
            {
                MainCameraControllerVariables.newZoom.z = 1.5f;
            }
